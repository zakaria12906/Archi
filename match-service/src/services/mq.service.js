...
exports.connectMQ = async () => {
  try {
    ...
    console.log("[Match-Service] Connecté à RabbitMQ");
  } catch (err) {
 ...
 * @param {string} routingKey - Clé de routage (ex: "match_started")
...
exports.publishEvent = async (routingKey, message) => {
  ...
  try {
    ...
    console.log(`[Match-Service] Événement publié : ${routingKey}`, message);
  } catch (err) {
